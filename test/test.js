...
describe('Overpass get', function() {
  ...
  describe('bbox query with GeoJSON', function() {
    ...
    it('should return a list of node features (fully cached - bounds within same bbox)', function(done) {
      var finalCalled = 0
      var found = []
      var expected = [ "n3037893160", "n3037893161", "n3037893162", "n3037893163", "n3037893164", "n3037882438", "n3037882439", "n3037893159" ]
      var expectedSubRequestCount = 0
      var foundSubRequestCount = 0
        ...
        'node[amenity=bench];',
        {
          ...
          "geometry": {
            ...
            "coordinates": [ [
              ...
              [ 16.33879691362381, 48.199175913895694 ],
              [ 16.338405311107635, 48.1992742432501 ],
              [ 16.338107585906982, 48.1992742432501 ],
              [ 16.338107585906982, 48.19878974587783 ]
            ] ]
          }
        },
    ...
    it('should return a list of node features (partly cached - should not re-request loaded objects)', function(done) {
      var finalCalled = 0
      var found = []
      var expected = ["n3037893161", "n3037893162", "n3037893163", "n3037893164"]
      var expectedSubRequestCount = 1
      ...
      function receiveObject (ob) {
        assert.equal(true, false, 'Should receive an empty result set!')
      }

      overpassFrontend.on('receive-object', receiveObject)
      ...
      var request = overpassFrontend.BBoxQuery(
        'node[amenity=bench];',
        {
          ...
          "geometry": {
            ...
            "coordinates": [ [
              [ 16.338107585906982, 48.19878974587783 ],
              [ 16.33889691362381, 48.199175913895694 ],
              [ 16.338405311107635, 48.1992742432501 ],
              [ 16.338107585906982, 48.19878974587783 ]
            ] ]
          }
        ...
        function(err) {
          ...
          request.off('subrequest-compile', compileListener)
          overpassFrontend.off('receive-object', receiveObject)
          done()
        }
      )
...
describe('Overpass objects structure', function() {
  ...
  describe('Way', function() {
    ...
    it('Line: method intersects() - only bbox known', function (done) {
      overpassFrontend.get('w299709373', { properties: OverpassFrontend.BBOX },
        function (err, result, index) {
          ...
          assert.equal(1, result.intersects({
            ...
            geometry: {
              type: "Polygon",
              coordinates: [ [
                [ 16.338230967521667, 48.198916681056694 ],
                [ 16.33845627307892, 48.198916681056694 ],
                [ 16.33845627307892, 48.19905255498419 ],
                [ 16.338230967521667, 48.19905255498419 ],
                [ 16.338230967521667, 48.198916681056694 ]
              ] ]
            }
          }))
          assert.equal(1, result.intersects({
            ...
            geometry: {
              type: "Polygon",
              coordinates: [ [
                [ 16.33820414543152, 48.19911512838224 ],
                [ 16.338394582271576, 48.19911512838224 ],
                [ 16.338394582271576, 48.19925278958888 ],
                [ 16.33820414543152, 48.19925278958888 ],
                [ 16.33820414543152, 48.19911512838224 ]
              ] ]
            }
          }))
          assert.equal(0, result.intersects({
            ...
            geometry: {
              type: "Polygon",
              coordinates: [ [
                [ 16.3378769159317, 48.19970331458798 ],
                [ 16.3380566239357, 48.19970331458798 ],
                [ 16.3380566239357, 48.199805218502604 ],
                [ 16.3378769159317, 48.199805218502604 ],
                [ 16.3378769159317, 48.19970331458798 ]
              ] ]
            }
          }))
          assert.equal(1, result.intersects({
            ...
            geometry: {
              "type": "Polygon",
              "coordinates": [ [
                  [ 16.337479948997498, 48.19977840170262 ],
                  [ 16.33765697479248, 48.19850190578585 ],
                  [ 16.338858604431152, 48.19787973658307 ],
                  [ 16.337479948997498, 48.19977840170262 ]
              ] ]
            }
          }))
    ...
    it('Line: method intersects() - full geom', function (done) {
      overpassFrontend.get('w299709373', { properties: OverpassFrontend.BBOX | OverpassFrontend.GEOM },
        function (err, result, index) {
          assert.equal(2, result.intersects(new BoundingBox({
              minlat: 48.198,
              maxlat: 48.199,
    ...
    it('Polygon: method intersects() - only bbox known', function (done) {
      overpassFrontend.get('w313063304', { properties: OverpassFrontend.BBOX },
        function (err, result, index) {
          assert.equal(1, result.intersects(new BoundingBox({
              minlat: 48.20028,
              maxlat: 48.20039,
          ...
          assert.equal(1, result.intersects({
            ...
            geometry: {
              type: "Polygon",
              coordinates: [ [
                  [ 16.33639097213745, 48.201205035970176 ],
                  [ 16.33844017982483, 48.200071597953524 ],
                  [ 16.338000297546387, 48.20091542170138 ],
                  [ 16.33639097213745, 48.201205035970176 ]
              ] ]
            }
          }))
        ...
        function (err, result, index) {
          ...
          assert.equal(1, result.intersects({
            ...
            geometry: {
              type: "Polygon",
              coordinates: [ [
                  [ 16.33793592453003, 48.19888092470012 ],
                  [ 16.33965253829956, 48.1981979734986 ],
                  [ 16.339067816734314, 48.1987557772555 ],
                  [ 16.33793592453003, 48.19888092470012 ]
              ] ]
            }
          }))
        ...
        function (err, result, index) {
          ...
          assert.equal(1, result.intersects({
            ...
            geometry: {
              type: "Polygon",
              coordinates: [ [
                  [ 16.335833072662354, 48.2019952097829 ],
                  [ 16.338526010513306, 48.20064368336772 ],
                  [ 16.337968111038204, 48.201508950417534 ],
                  [ 16.335833072662354, 48.2019952097829 ]
              ] ]
            }
          }))
